  ...
  render() {
    return(
      <React.Fragment>
          ...
          <div className="grid">
            <TableList tables={this.props.tables} date={this.state.date} time={this.state.time} handleNewBooking={this.handleNewBooking} editBooking={this.props.editBooking}/>
